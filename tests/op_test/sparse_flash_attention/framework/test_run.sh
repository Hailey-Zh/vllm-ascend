...
TEST_BATCH_SCRIPT="test_sparse_flash_attention_batch.py"
TEST_SINGLE_SCRIPT="test_sparse_flash_attention_single.py"
...
show_help() {
    ...
    echo "                选项: -P paramset_file (指定 paramset 文件名，默认: sparse_flash_attention_paramset)"
    echo ""
